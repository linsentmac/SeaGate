...
namespace LARSuite
{
    public class GyroController : MonoBehaviour
    {
        ...
        private const float lowPassFilterFactor = 2.5f;
        ...
        protected void Start()
        {
            ...
            Input.gyro.updateInterval = 0.004f;
        }
...

        {
            ...
            //       cameraBase * ( ConvertRotation(referanceRotation * Input.gyro.attitude) * GetRotFix()), lowPassFilterFactor*Time.time);
